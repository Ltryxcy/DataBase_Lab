    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_deadline', models.DateTimeField(default=datetime.datetime(2027, 6, 3, 12, 39, 12, 349968))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_departmanager', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='StaffManager', to='myBankSystem.bank_staff')),
            ],
